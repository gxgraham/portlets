...
import com.inversasystems.NoSuchFooException;

import com.inversasystems.model.Foo;
import com.inversasystems.model.impl.FooImpl;
import com.inversasystems.model.impl.FooModelImpl;
...
public class FooPersistenceImpl extends BasePersistenceImpl<Foo>
	...
	@Override
	public Foo updateImpl(com.inversasystems.model.Foo foo, boolean merge)
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.inversasystems.model.Foo")));
