...
package com.inversasystems.service.base;

import com.inversasystems.service.FooLocalServiceUtil;
...
public class FooLocalServiceClpInvoker {
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName0.equals(name) &&
			...
			return FooLocalServiceUtil.addFoo((com.inversasystems.model.Foo)arguments[0]);
		}
		...
		if (_methodName3.equals(name) &&
			...
			return FooLocalServiceUtil.deleteFoo((com.inversasystems.model.Foo)arguments[0]);
		}
		...
		if (_methodName14.equals(name) &&
			...
			return FooLocalServiceUtil.updateFoo((com.inversasystems.model.Foo)arguments[0]);
		}
