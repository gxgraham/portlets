...
public class FooWrapper implements Foo, ModelWrapper<Foo> {
	...
	*/
	...
	public int compareTo(com.inversasystems.model.Foo foo) {
	...
	public com.liferay.portal.model.CacheModel<com.inversasystems.model.Foo> toCacheModel() {
		return _foo.toCacheModel();
	}

	public com.inversasystems.model.Foo toEscapedModel() {
